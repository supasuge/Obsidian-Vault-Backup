...
|   |   |
|---|---|
|`nslookup ns1.inlanefreight.com`|Used to query the domain name\n system and discover the IP address to domain\n name mapping of the target entered from a Linux-based host.|
...
# NoPac
[Offensive WMI - Active Directory Enumeration (Part 5) :: 0xInfection's Blog — Ramblings of an Infected Geek.](https://0xinfection.github.io/posts/wmi-ad-enum/)
