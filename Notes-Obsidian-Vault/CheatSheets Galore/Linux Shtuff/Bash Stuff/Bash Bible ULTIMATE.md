...
- [FOREWORD](#foreword)
- [STRINGS](#strings)
  - [Trim leading and trailing white-space from string](#Trim\leading\and\trailing\white-space\from\string)
  - [Trim all white-space from string and truncate spaces](#Trim\all\white-space\from\string\and\truncate\spaces)
- [shellcheck disable=SC2086,SC2048](#shellcheck\disable=sc2086,sc2048)
  - [Use regex on a string](#Use\regex\on\a\string)
- [no output (invalid)](#no\output\(invalid))
- [Do stuff.](#do\stuff.)
  - [Split a string on a delimiter](#Split\a\string\on\a\delimiter)
- [Multi char delimiters work too!](#multi\char\delimiters\work\too!)
  - [Change a string to lowercase](#Change\a\string\to\lowercase)
  - [Change a string to uppercase](#Change\a\string\to\uppercase)
...
- [Inverse (substring not in string).](#inverse\(substring\not\in\string).)
- [This works for arrays too!](#this\works\for\arrays\too!)
  - [Check if string starts with sub-string](#Check\if\string\starts\with\sub-string)
- [Inverse (var does not start with sub_string).](#inverse\(var\does\not\start\with\sub_string).)
  - [Check if string ends with sub-string](#Check\if\string\ends\with\sub-string)
- [Inverse (var does not end with sub_string).](#inverse\(var\does\not\end\with\sub_string).)
- [ARRAYS](#arrays)
  - [Reverse an array](#Reverse\an\array)
  - [Remove duplicate array elements](#Remove\duplicate\array\elements)
  - [Random array element](#Random\array\element)
- [Multiple arguments can also be passed.](#multiple\arguments\can\also\be\passed.)
  - [Cycle through an array](#Cycle\through\an\array)
  - [Toggle between two values](#Toggle\between\two\values)
- [LOOPS](#loops)
  - [Loop over a range of numbers](#Loop\over\a\range\of\numbers)
- [Loop from 0-100 (no variable support).](#loop\from\0-100\(no\variable\support).)
  - [Loop over a variable range of numbers](#Loop\over\a\variable\range\of\numbers)
- [Loop from 0-VAR.](#loop\from\0-var.)
  - [Loop over an array](#Loop\over\an\array)
- [Just elements.](#just\elements.)
  - [Loop over an array with an index](#Loop\over\an\array\with\an\index)
- [Elements and index.](#elements\and\index.)
- [Alternative method.](#alternative\method.)
  - [Loop over the contents of a file](#Loop\over\the\contents\of\a\file)
...
- [FILE HANDLING](#file\handling)
  - [Read a file to a string](#Read\a\file\to\a\string)
  - [Read a file to an array (*by line*)](#Read\a\file\to\an\array\(*by\line*))
- [Bash <4 (discarding empty lines).](#bash\<4\(discarding\empty\lines).)
- [Bash <4 (preserving empty lines).](#bash\<4\(preserving\empty\lines).)
- [Bash 4+](#bash\4+)
  - [Get the first N lines of a file](#Get\the\first\N\lines\of\a\file)
- [Prompt](#prompt)
- [Prompt](#prompt)
  - [Get the last N lines of a file](#Get\the\last\N\lines\of\a\file)
- [Enable tmux.](#enable\tmux.)
- [[[ -z "$TMUX"  ]] && exec tmux](#[[\-z\"$tmux"\\]]\&&\exec\tmux)
- [[[ -z "$TMUX"  ]] && exec tmux](#[[\-z\"$tmux"\\]]\&&\exec\tmux)
  - [Get the number of lines in a file](#Get\the\number\of\lines\in\a\file)
  - [Count files or directories in directory](#Count\files\or\directories\in\directory)
- [Count all files in dir.](#count\all\files\in\dir.)
- [Count all dirs in dir.](#count\all\dirs\in\dir.)
- [Count all jpg files in dir.](#count\all\jpg\files\in\dir.)
  - [Create an empty file](#Create\an\empty\file)
- [Shortest.](#shortest.)
- [Longer alternatives:](#longer\alternatives:)
  - [Extract lines between two markers](#Extract\lines\between\two\markers)
- [Extract code blocks from MarkDown file.](#extract\code\blocks\from\markdown\file.)
- [Output here...](#output\here...)
- [FILE PATHS](#file\paths)
  - [Get the directory name of a file path](#Get\the\directory\name\of\a\file\path)
  - [Get the base-name of a file path](#Get\the\base-name\of\a\file\path)
- [VARIABLES](#variables)
  - [Assign and access a variable using a variable](#Assign\and\access\a\variable\using\a\variable)
- [Create the variable name.](#create\the\variable\name.)
- [Print the value of the variable name stored in 'hello_$var'.](#print\the\value\of\the\variable\name\stored\in\'hello_$var'.)
- [Declare a nameref.](#declare\a\nameref.)
...
- [BRACE EXPANSION](#brace\expansion)
  - [Ranges](#Ranges)
- [Syntax: {<START>..<END>}](#syntax:\{<start>..<end>})
- [Print numbers 1-100.](#print\numbers\1-100.)
- [Print range of floats.](#print\range\of\floats.)
- [Print chars a-z.](#print\chars\a-z.)
- [Nesting.](#nesting.)
- [Print zero-padded numbers.](#print\zero-padded\numbers.)
- [CAVEAT: bash 4+](#caveat:\bash\4+)
- [Change increment amount.](#change\increment\amount.)
- [Syntax: {<START>..<END>..<INCREMENT>}](#syntax:\{<start>..<end>..<increment>})
- [CAVEAT: bash 4+](#caveat:\bash\4+)
  - [String Lists](#String\Lists)
- [Example Usage:](#example\usage:)
- [Remove dirs Movies, Music and ISOS from ~/Downloads/.](#remove\dirs\movies,\music\and\isos\from\~/downloads/.)
...
- [ARITHMETIC](#arithmetic)
  - [Simpler syntax to set variables](#Simpler\syntax\to\set\variables)
- [Simple math](#simple\math)
- [Decrement/Increment variable](#decrement/increment\variable)
- [Using variables](#using\variables)
  - [Ternary Tests](#Ternary\Tests)
- [Set the value of var to var2 if var2 is greater than var.](#set\the\value\of\var\to\var2\if\var2\is\greater\than\var.)
- [var: variable to set.](#var:\variable\to\set.)
- [var2>var: Condition to test.](#var2>var:\condition\to\test.)
- [?var2: If the test succeeds.](#?var2:\if\the\test\succeeds.)
- [:var: If the test fails.](#:var:\if\the\test\fails.)
- [TRAPS](#traps)
  - [Do something on script exit](#Do\something\on\script\exit)
- [Clear screen on script exit.](#clear\screen\on\script\exit.)
  - [Ignore terminal interrupt (CTRL+C, SIGINT)](#Ignore\terminal\interrupt\(CTRL+C,\SIGINT))
  - [React to window resize](#React\to\window\resize)
- [Call a function on window resize.](#call\a\function\on\window\resize.)
...
- [OBSOLETE SYNTAX](#obsolete\syntax)
  - [Shebang](#Shebang)
- [Right:](#right:)
- [Less right:](#less\right:)
  - [Command Substitution](#Command\Substitution)
- [Right.](#right.)
- [Wrong.](#wrong.)
- [$() can easily be nested whereas `` cannot.](#$()\can\easily\be\nested\whereas\``\cannot.)
  - [Function Declaration](#Function\Declaration)
- [Right.](#right.)
- [Wrong.](#wrong.)
- [INTERNAL VARIABLES](#internal\variables)
  - [Get the location to the `bash` binary](#Get\the\location\to\the\`bash`\binary)
  - [Get the version of the current running `bash` process](#Get\the\version\of\the\current\running\`bash`\process)
- [As a string.](#as\a\string.)
- [As an array.](#as\an\array.)
  - [Open the user's preferred text editor](#Open\the\user's\preferred\text\editor)
- [NOTE: This variable may be empty, set a fallback value.](#note:\this\variable\may\be\empty,\set\a\fallback\value.)
  - [Get the name of the current function](#Get\the\name\of\the\current\function)
- [Current function.](#current\function.)
- [Parent function.](#parent\function.)
- [So on and so forth.](#so\on\and\so\forth.)
- [All functions including parents.](#all\functions\including\parents.)
  - [Get the host-name of the system](#Get\the\host-name\of\the\system)
- [NOTE: This variable may be empty.](#note:\this\variable\may\be\empty.)
- [Optionally set a fallback to the hostname command.](#optionally\set\a\fallback\to\the\hostname\command.)
  - [Get the architecture of the Operating System](#Get\the\architecture\of\the\Operating\System)
  - [Get the name of the Operating System / Kernel](#Get\the\name\of\the\Operating\System\/\Kernel)
  - [Get the current working directory](#Get\the\current\working\directory)
  - [Get the number of seconds the script has been running](#Get\the\number\of\seconds\the\script\has\been\running)
  - [Get a pseudorandom integer](#Get\a\pseudorandom\integer)
- [INFORMATION ABOUT THE TERMINAL](#information\about\the\terminal)
  - [Get the terminal size in lines and columns (*from a script*)](#Get\the\terminal\size\in\lines\and\columns\(*from\a\script*))
- [Output: LINES COLUMNS](#output:\lines\columns)
  - [Get the terminal size in pixels](#Get\the\terminal\size\in\pixels)
- [Output: WIDTHxHEIGHT](#output:\widthxheight)
- [Output (fail):](#output\(fail):)
  - [Get the current cursor position](#Get\the\current\cursor\position)
- [Output: X Y](#output:\x\y)
- [CONVERSION](#conversion)
  - [Convert a hex color to RGB](#Convert\a\hex\color\to\RGB)
  - [Convert an RGB color to hex](#Convert\an\RGB\color\to\hex)
- [CODE GOLF](#code\golf)
...
- [This can be used to assign integer values.](#this\can\be\used\to\assign\integer\values.)
- [Example: f a=1](#example:\f\a=1)
- [f a++](#f\a++)
- [Using tests, loops etc.](#using\tests,\loops\etc.)
- [NOTE: ‘while’, ‘until’, ‘case’, ‘(())’, ‘[[]]’ can also be used.](#note:\‘while’,\‘until’,\‘case’,\‘(())’,\‘[[]]’\can\also\be\used.)
  - [Shorter `if` syntax](#Shorter\`if`\syntax)
- [One line](#one\line)
- [Note: The 3rd statement may run when the 1st is true](#note:\the\3rd\statement\may\run\when\the\1st\is\true)
- [Multi line (no else, single statement)](#multi\line\(no\else,\single\statement))
- [Note: The exit status may not be the same as with an if statement](#note:\the\exit\status\may\not\be\the\same\as\with\an\if\statement)
- [Multi line (no else)](#multi\line\(no\else))
  - [Simpler `case` statement to set variable](#Simpler\`case`\statement\to\set\variable)
- [Modified snippet from Neofetch.](#modified\snippet\from\neofetch.)
- [Finally, set the variable.](#finally,\set\the\variable.)
- [OTHER](#other)
  - [Use `read` as an alternative to the `sleep` command](#Use\`read`\as\an\alternative\to\the\`sleep`\command)
  - [Check if a program is in the user's PATH](#Check\if\a\program\is\in\the\user's\PATH)
- [There are 3 ways to do this and either one can be used.](#there\are\3\ways\to\do\this\and\either\one\can\be\used.)
- [As a test.](#as\a\test.)
- [Inverse.](#inverse.)
- [Example (Exit early if program is not installed).](#example\(exit\early\if\program\is\not\installed).)
  - [Get the current date using `strftime`](#Get\the\current\date\using\`strftime`)
- [Using above function.](#using\above\function.)
- [Using printf directly.](#using\printf\directly.)
- [Assigning a variable using printf.](#assigning\a\variable\using\printf.)
  - [Get the username of the current user](#Get\the\username\of\the\current\user)
- [Expand the parameter as if it were a prompt string.](#expand\the\parameter\as\if\it\were\a\prompt\string.)
  - [Generate a UUID V4](#Generate\a\UUID\V4)
  - [Progress bars](#Progress\bars)
  - [Get the list of functions in a script](#Get\the\list\of\functions\in\a\script)
...
- [function](#function)
- [command](#command)
  - [Run a command in the background](#Run\a\command\in\the\background)
  - [Capture the return value of a function without command substitution](#Capture\the\return\value\of\a\function\without\command\substitution)
- [AFTERWORD](#afterword)
