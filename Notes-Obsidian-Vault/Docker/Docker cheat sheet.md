...
- [Docker Cheat Sheet](#docker\cheat\sheet)
  ...
  - [Installation](#Installation)
    ...
    - [macOS](#macOS)
    - [Windows 10](#Windows\10)
- [Display the version of docker installed:](#display\the\version\of\docker\installed:)
- [Pull, create, and run 'hello-world':](#pull,\create,\and\run\'hello-world':)
...
- [create a new bridge network with your subnet and gateway for your ip block](#create\a\new\bridge\network\with\your\subnet\and\gateway\for\your\ip\block)
- [run a nginx container with a specific ip in that block](#run\a\nginx\container\with\a\specific\ip\in\that\block)
- [curl the ip from any other place (assuming this is a public ip block duh)](#curl\the\ip\from\any\other\place\(assuming\this\is\a\public\ip\block\duh))
...
- [copy file from container](#copy\file\from\container)
- [edit file](#edit\file)
- [start container with modified configuration](#start\container\with\modified\configuration)
